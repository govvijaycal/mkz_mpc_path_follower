...
module KinMPCPathFollower
	...
	v_ref = 10.0							# target velocity for path follower
    ...
    # Cost function gains.
    C_x = 1.0				# longitudinal deviation
    C_y = 10.0				# lateral deviation
    C_psi = 500.0			# heading deviation
    C_v   = 10.0			# target velocity deviation

	C_dacc	 = 50.0			# derivative of acceleration input
	C_ddf	 = 1000.0		# derivative of tire angle input
	C_acc	 = 100.0		# acceleration input
	C_df	 = 1000.0		# tire angle input
